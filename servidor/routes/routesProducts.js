...
import { bookProduct, buyProducts,getAllProducts,getProduct, getProductCategory,createProduct,updateProducts,deleteProduct } from "../controllers/ProductControllers.js";//obteniendo todos los controladores ya creados para ser usados
...
router.get('/categoria/:id', getProductCategory)
